  ...
  <q-dialog ref="dialog" @hide="onDialogHide">
    <q-card class="q-dialog-plugin barra">
        <div class="form">
            ...
            <q-input filled color="primary" label="Nombre" v-model="task.name">
                <template v-slot:prepend>
                    <q-icon name="note_add" />
                </template>
            </q-input>
            <q-input filled color="primary" label="Comentario" type="textarea" v-model="task.commentary">
                <template v-slot:prepend>
                    <q-icon name="description" />
                </template>
            </q-input>
            <q-input filled color="primary" label="Fecha y hora" required :rules="[val => !!val || 'Tienes que llenar este campo']" v-model="task.date">
                <template v-slot:prepend>
